...
<?php
#
# $Id: krisp-geoisp.php,v 1.1 2010-06-07 11:31:27 oops Exp $
#
# Merge KRISP data and GeoIP-GeoISP-Merge CVS format
#
...
Usage: {$prog} [opt]
Options:
            -g|--geoisp=GEOISP_CVS  path of GeoIP-GeoISP merge cvs format file
